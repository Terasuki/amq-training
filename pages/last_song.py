...
def last_song_anime():
    return html.Div(id="last_song_anime")


def last_song_song():
    return html.Div(id="last_song_song")


def last_song_artist():
    return html.Div(id="last_song_artist")


def last_song_type():
    return html.Div(id="last_song_type")


def last_song_links():
    return html.Div(
        id="last_song_links", style={"margin": "auto", "text-align": "center"}
    )


def last_song_difficulty():
    return html.Div(id="last_song_difficulty")
...
def update(n):
    ...
    ls_anime = html.P(
        last_song.romaji_title, style={"text-align": "center"}, className="card-text"
    )
    ls_song = html.P(
        last_song.name, style={"text-align": "center"}, className="card-text"
    )
    ls_artist = html.P(
        last_song.artist, style={"text-align": "center"}, className="card-text"
    )
    ls_type = html.P(
        last_song.type, style={"text-align": "center"}, className="card-text"
    )
    ls_difficulty = html.P(
        last_song.difficulty, style={"text-align": "center"}, className="card-text"
    )
    ls_song_links = html.P(
        [
            html.A(
                link["name"],
                href=link["url"],
